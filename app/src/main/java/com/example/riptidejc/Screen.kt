...
sealed class Screen(val route: String) {
    ...
    object TeacherFeedScreen: Screen("teacherfeed_screen")
    object ViewQuestionScreen: Screen("viewquestion_screen")
    object VoiceSessionScreen: Screen("voicesession_screen")
}
